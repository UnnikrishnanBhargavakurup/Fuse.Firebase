...
function signedIn() {
    ...
    try {
      ...
      database.Put("messages", "hello")
        .then(function(msg) {
            console.log("success message " + msg);
        }, function(err) {
            console.log("Error: " + err);
        });
      console.log("attaching event listner");
      database.Listen("messages");
      database.on("onDataChange", function(message) {
        console.log("Message received "+ message);
      });
    } catch (err){
        console.log("unable to load module database");
